                  ...
                  {'khachHang' in values && (
                    <div className="form-group mb-20px">
                      ...
                      <AsyncSelectMembers
                        ...
                        onChange={otp => {
                          setFieldValue('khachHang', otp, false)
                        }}
                      />
                    </div>
                  )}
                  {'trangthai' in values && (
                    <div className="form-group mb-20px">
                      ...
                      <Select
                        ...
                        classNamePrefix="select"
                        options={[
                          { label: 'Đã thanh toán', value: 'da_kich_hoat' },
                          { label: 'Chờ thanh toán', value: 'cho_tt' }
                        ]}
                        className="select-control"
                        value={values.trangthai}
                        onChange={otp => {
                          setFieldValue('trangthai', otp)
                        }}
                      />
                    </div>
                  )}
